---
title: "CLR via C# Chapter 12 - Generics 深度笔记"
date: 2026-05-15
categories:
  - 书籍
tags:
  ...
  - 泛型
  - C# 高级特性
description: "CLR via C# Chapter 12 泛型章节深度学习笔记，包含性能分析、类型系统、协变逆变等核心概念"
---
...
- [Microsoft Docs: Covariance and Contravariance](https://docs.microsoft.com/en-us/dotnet/standard/generics/covariance-and-contravariance)

### 经典书籍
- **《CLR via C#》(第4版)** - Jeffrey Richter - 深入讲解底层机制
- **《C# in Depth》(第4版)** - Jon Skeet - 详细讲解泛型高级特性
- **《Effective C#》** - Bill Wagner - 最佳实践和设计模式

### 实践项目
- **GitHub**: [.NET Collections Source Code](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Private.CoreLib/src/System/Collections)
- **GitHub**: [MoreLINQ](https://github.com/morelinq/MoreLINQ) - 扩展LINQ方法库
